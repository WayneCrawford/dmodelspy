...
for z, Ztxt in zip([0, 500], ['', '_500m']):
    ...
    u, v, w, dV, *_ = sill.calc_all(x, y, z)
...
# Plot ground tilt
_, _, _, _, dwdx, dwdy, *_ = sill.calc_all(x, y, 0)
...
# Plot strain
_, _, _, _, _, _, eea, g1, g2 = sill.calc_all(x, y, 500)
EEA = pd.read_csv('FEM/sill_eea_r_500m.txt', **csv_kwargs)
G1 = pd.read_csv('FEM/sill_gamma1_r_500m.txt', **csv_kwargs)
G2 = pd.read_csv('FEM/sill_gamma2_r_500m.txt', **csv_kwargs)
