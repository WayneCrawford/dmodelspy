function [u v w dwdx dwdy eea gamma1 gamma2] = okada92fault(fault,xi,yi,xf,yf,zt,zb,U,delta,mu,nu,x,y,z)
...
for i=1:N                                                                   % loop over patches
    [Up Vp Wp Dwdxp Dwdyp Eeap Gamma1p Gamma2p] = okada92(fault,xi(i),yi(i),xf(i),yf(i),zt(i),zb(i),U(i),delta(i),mu,nu,x,y,z);
