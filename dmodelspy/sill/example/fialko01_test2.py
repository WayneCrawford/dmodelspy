...
# TILT ********************************************************************
_, _, _, _, dwdx, dwdy, *_ = fialko01(x0, y0, z0, P_G, a, nu, x, y, 0)
# plot ground tilt
...
_, _, _, _, _, _, eea, gamma1, gamma2 = fialko01(x0, y0, z0, P_G, a, nu,
                                                 x, y, 500)
# plot strain
# figure('Position',concat([10,scrsz(4)/5,dot(2,scrsz(3))/3,scrsz(4)/3]))
...
ax = axs[2]
ax.plot(dot(0.001, r), gamma2, 'r.')
ax.plot(dot(0.001, GAMMA2['X']), GAMMA2['Y'], 'b')
ax.set_title('$\\gamma_2$')
ax.legend('analytical', 'FEM')
